...
extension Brewery {
    ...
    static func exampleBrewery(name: String, street: String? = nil, address2: String? = nil, address3: String? = nil, city: String = "", state: String = "", postalCode: String = "", latitude: String = "", longitude: String = "", phone: String? = nil) -> Brewery {
        Brewery(name: name, breweryType: "", street: street, address2: address2, address3: address3, city: city, state: state, postalCode: postalCode, country: "", longitude: longitude, latitude: latitude, phone: phone, websiteUrl: nil)
    }
}
